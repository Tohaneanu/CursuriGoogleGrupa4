...
input_frame = Frame(window, width=312, height=50, bd=0, highlightcolor='black', highlightbackground='black', bg='green')
...
zero = Button(frame_button, text="0", fg="black", width=18, height=3, bd=1, bg="#eee", cursor='hand2',
              command=lambda: click('0'))
zero.grid(row=4, column=1)

virgula = Button(frame_button, text=",", fg="black", width=18, height=3, bd=1, bg='#FFA500', cursor='hand2',
                 command=lambda: click(','))
